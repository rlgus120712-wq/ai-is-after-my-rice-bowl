          ...
          <div className="mt-3 border-t border-zinc-100 pt-3 dark:border-zinc-800">
            {user ? (
              <div className="flex flex-col gap-2">
                <Link
                  href="/blog/new"
                  className="block rounded-lg bg-violet-600 px-4 py-3 text-center text-base font-semibold text-white hover:bg-violet-500 transition-colors"
                >
                  ✍️ 글 쓰기
                </Link>
                <button
                  onClick={handleLogout}
                  className="block w-full rounded-lg px-4 py-3 text-left text-base text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
                >
                  로그아웃
                </button>
              </div>
              ...
              <button
                onClick={handleLogin}
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 px-4 py-3 text-base font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-colors"
              >
